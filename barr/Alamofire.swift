...
struct AlamoHelper {
    ...
    static let domain = "http://128.237.215.81:3000/"
    ...
    static func authorizedPost(subdomain: String, parameters: [String: AnyObject], completion: (err: NSError?, response: JSON?) -> Void){
        if let accessToken = Me.user.accessToken, userId = Me.user.userId {
            var params = parameters;
            params["x_key"] = userId;
            params["access_token"] = accessToken;
            self.POST(subdomain, parameters: params, completion: completion);
        }
    }
    ...
    static func DELETE(subdomain: String, parameters: [String: AnyObject], completion: (err: NSError?,response: JSON?) -> Void){
        deleteAttempt(subdomain, parameters: parameters, completion: completion, attempt: 0);
    }
    ...
    static func deleteAttempt(subdomain: String, parameters:[String: AnyObject], completion: (err: NSError?, response: JSON?) -> Void, attempt: UInt64){
